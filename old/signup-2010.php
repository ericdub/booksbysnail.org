...
<div id="snail-form">
  ...
  <p><strong>Tell us what books you&rsquo;d like to start with or check some categories you like and we&rsquo;ll choose some for you. </strong>We&rsquo;ll check out up to three books and mail them to you. When you&rsquo;re done reading, you&rsquo;ll send us the 
    ...
    1 through August 20, 2010.</p>
  <p>Books by Snail is available to students in Auxvasse, Hallsville, Harrisburg, Holts Summit, Mokane, New Bloomfield, Sturgeon and Williamsburg. For more information, call 1-800-324-4806 or <a href="http://www.dbrl.org/contact?c=bbs">e-mail us</a>.</p>
  <p><strong>Fill out the form below to sign up.</strong> <em>(The library will <strong>not</strong> share your personal information.)</em> </p>
  <div class="clear"></div>	
...
<!--  <input type="hidden" name="mail_options" id="mail_options" value="PlainTemplate=snail-request.txt,TemplateMissing=" />-->
  ...
  <input name="LCN" id="LCN" type="text" value="" size="14" maxlength="14" /><br />
  ...
  <div class="clear"></div>
	...
	<div class="check-group">
  	...
  	<div class="check-group"> 
		...
		<label for="OTHERTHEME">Other</label><input name="OTHERTHEME" id="OTHERTHEME" type="text" 
size="45" /><br />			
	</div>
