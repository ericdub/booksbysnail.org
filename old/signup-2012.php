...
<div id="snail-form">
  ...
  <p><strong>Tell us what books you&rsquo;d like to start with or check some categories you like and we&rsquo;ll choose some for you. </strong>We&rsquo;ll check out up to three books and mail them to you. When you&rsquo;re done reading, you&rsquo;ll send us the books back in our envelope along with your request for more, all for free. <strong>We will send books June 1 through August 4, 2012.</strong> We&rsquo;ll also send you all the materials and rewards you get when you sign up for Summer Reading.</p>
...
<!--  <input type="hidden" name="mail_options" id="mail_options" value="PlainTemplate=snail-request.txt,TemplateMissing=" />-->
  ...
  <input name="email" id="email" type="text" value="" size="25" /><small> (optional)</small><br /><br />
 ...
 <label for="SCHOOL">Which school do you go to?</label>
  ...
  <div class="check-group-long"> 
	  ...
	  <input name="PICTURE_TOREAD" id="PICTURE_TOREAD" type="checkbox" value="Yes" />
	  <label for="BOOKS-PICTURES">Picture books that I can try reading on my own or with some help.</label><br />
  ...
  <div class="clear"></div>
	...
	<div class="check-group">
		<input name="Adventure" id="Adventure" type="checkbox" value="Yes" /><label for="Adventure">Action &amp; Adventure</label><br />
