...
<div id="snail-form">
  ...
  <p><strong>Tell us what books you&rsquo;d like to start with or check some categories you like and we&rsquo;ll choose some for you.</strong> We&rsquo;ll check out up to 3 books and mail them to you. When you&rsquo;re done reading, you&rsquo;ll send us the books back in our envelope along with your request for more, all for free. <strong>We will send books May 28 through July 26, 2013.</strong> We&rsquo;ll also send you all the materials and rewards you get when you sign up for Summer Reading.</p>
...
<!--  <input type="hidden" name="mail_options" id="mail_options" value="PlainTemplate=snail-request.txt,TemplateMissing=" />-->
  ...
  <label for="realname">Parent's Name *</label>
 ...
 <label for="SCHOOL">Which school do you go to?</label>
  ...
  <input name="LCNc" id="LCNc" type="text" value="" size="18" maxlength="14" /><br />
